...
function openCostsDB(databaseName, databaseVersion) {
  ...
  return {
    ...
    // (R-035), appends to the stored list, and returns a copy of the newly
    // stored cost — including the extra id/date fields, since the course
    // Q&A does not restrict the returned object to only the four input
    // properties.
    addCost(cost) {
      validateCost(cost);
